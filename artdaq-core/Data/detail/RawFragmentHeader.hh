...
struct artdaq::detail::RawFragmentHeader
{
	...
	static constexpr type_t EndOfRunDataFragmentType = FIRST_SYSTEM_TYPE + 11;     ///< This Fragment contains an art Run object
	static constexpr type_t EndOfSubrunDataFragmentType = FIRST_SYSTEM_TYPE + 12;  ///< This Fragment contains an art Subrun object
